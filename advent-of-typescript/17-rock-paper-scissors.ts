...
type GreaterThan<T extends RockPaperScissors> =
  T extends Paper ? Scissors : T extends Scissors ? Rock : Paper;
type WhoWins<Opponent extends RockPaperScissors, Player extends RockPaperScissors> =
  Player extends Opponent ? 'draw' : // self-explanatory
  Player extends GreaterThan<Opponent> ? 'win' : 'lose'
	;
