...
// type definition
type Count<Toys extends unknown[], Toy extends string, Cnt extends any[] = []> =
  Toys extends [] ? Cnt["length"] : // end of recursion
	Toys extends [infer First, ...infer Rest] ?
	  First extends Toy ? Count<Rest, Toy, [...Cnt, 0]> : // toy found here
		Count<Rest, Toy, Cnt> : // toy not found here
	  never
	;
